...
// cuadrado de 2 = 2*2, no esta bien corregir
let cuadrado = (+numero1,+numero2) => {
    let duplicar1 = (+numero1*numero1)
    let duplicar2 = (+numero2*numero2)
    return cuadrado duplicar1 "y" duplicar2
}

//funcion que pida nombre y apellido y edad
// y retorne mensaje de saludo, esta bien

const saludar = (nombre,apellido,edad) => {
return `Hola ${nombre} ${apellido} tienes ${edad} años`
}

//creen un arrow function que retorne el area de un rectangulo
//  base x altura
...
const esMayor = edad => {
    if (edad >= 18) {
    return "es mayor de edad"     // ->texto
}   else {                     //si quiero con vavriable adentro
    return "es menor de edad" // `es menor de edad ${edad}`
}}
// o 
...
//quiero una funcion que reciba un array, y 
//si el lenght del array es mayor a 5, entonces retorna
//arreglo grande, si no retorna arreglo pequeño
//Usando el operador ternario 


const definirTamañoDeArreglo = (arreglo) =>
...
return(`los cuadrados son ${num1**2} y ${num2**2}`)
}
